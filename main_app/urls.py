...
urlpatterns = [
    ...
    path('assoc_toy/<int:finch_id>/<int:toy_id>/', views.assoc_toy, name='assoc_toy'),
    path('unassociated_toy/<int:finch_id>/<int:toy_id>/', views.unassociated_toy, name='unassociated_toy'),
